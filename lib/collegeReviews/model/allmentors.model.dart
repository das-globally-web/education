...
AllUniModel allMentorsModelFromJson(String str) => AllUniModel.fromJson(json.decode(str));

String allMentorsModelToJson(AllUniModel data) => json.encode(data.toJson());

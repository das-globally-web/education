...
class _LognService implements LognService {
  _LognService(
    this._dio, {
    this.baseUrl,
    this.errorLogger,
  ...
  @override
  Future<RefreshTokenResMoedl> refreshToken(RefreshTokenBodyModel body) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
    _data.addAll(body.toJson());
    final _options = _setStreamType<RefreshTokenResMoedl>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
    )
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late RefreshTokenResMoedl _value;
    try {
      _value = RefreshTokenResMoedl.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
